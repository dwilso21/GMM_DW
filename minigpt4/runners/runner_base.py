...
class RunnerBase:
    ...
    def __init__(self, cfg, task, model, datasets, job_id, task_id):
        self.config = cfg
        self.job_id = job_id
    ...
    def setup_output_dir(self):
        ...
        # output_dir = lib_root / self.config.run_cfg.output_dir / self.job_id / self.task_id
        # result_dir = output_dir / "result" / self.task_id        
